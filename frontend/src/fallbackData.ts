      ...
      versions: [
        {
          ...
          checks: [
            { name: "schema", label: "Questions come from our backend", source: "agent", verdict: "pass", detail: "PASS" },
            { name: "assertions", label: "The game's own tests pass", source: "agent", verdict: "pass", detail: "PASS" },
            { name: "playthrough", label: "A full level can actually be completed", source: "agent", verdict: "pass", detail: "PASS" },
            { name: "render_accessibility", label: "Readable, keyboard reachable, no fast flashing", source: "agent", verdict: "pass", detail: "PASS" },
            { name: "files", label: "The files it claims to have written exist", source: "ours", verdict: "pass", detail: "PASS" },
            { name: "shell_contract", label: "It asks us for questions instead of inventing them", source: "ours", verdict: "pass", detail: "PASS" },
            { name: "instrumentation", label: "Every event Loop B reads is still emitted", source: "ours", verdict: "pass", detail: "PASS" },
            { name: "no_fast_flashing", label: "Nothing flashes faster than 3Hz (WCAG 2.3.1)", source: "ours", verdict: "pass", detail: "PASS" },
            { name: "focus_visible", label: "Focus is visible for keyboard play", source: "ours", verdict: "pass", detail: "PASS" },
            { name: "playthrough", label: "We played it headless and it answered questions", source: "ours", verdict: "pass", detail: "PASS" },
          ],
          checks_passed: true,
          blocked_by: [],
          verdict: {
